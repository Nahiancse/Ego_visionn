...
class FCartScreen extends StatefulWidget {
  const FCartScreen({Key? key}) : super(key: key);

  @override
  _CartScreenState createState() => _CartScreenState();
}

class _CartScreenState extends State<FCartScreen> {
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Image(
                                            ...
                                            width: 100,
                                            image: NetworkImage(
                                                'http://egovision24.com/uploads/product/${snapshot.data![index].image.toString()}'),
                                          ),
                                          SizedBox(
                                            width: 10,
                                          ),
